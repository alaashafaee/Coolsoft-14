...
ActiveRecord::Schema.define(version: 20140327152228) do
	...
	add_index "teaching_assistants", ["reset_password_token"], 
				name: "index_teaching_assistants_on_reset_password_token", unique: true
	...
	add_index "track_progressions", ["student_id", "topic_id"],
			 name: "index_track_progressions_on_student_id_and_topic_id", unique: true
