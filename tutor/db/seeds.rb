...
puts("# ----------------------- Hints ----------------------- ")
	Hint.create(message: "Do not Try to Solve CS problem-1", category: false, time: 5, submission_counter:10)
 	...
 	Hint.create(id: 511, message: "No hints needed; very easy problem.", category: false, time: 1, submission_counter:10)
 	Hint.create(id: 512, message: "No hints needed; very easy problem.", category: false, time: 1, submission_counter:10)
	Hint.create(message: "Do not Try to Solve CS problem-2", category: true, time: 5, submission_counter:10)
	Hint.create(message: "Do not Try to Solve CS problem-3", category: false, time: 5, submission_counter:10)
...
puts("# ----------------------- ModelAnswer ----------------------- ")
	...
	ModelAnswer.create(id: 511, title: "Multiplication", answer: "int a, b, c; a = b*c; System.out.println(a);")
	ModelAnswer.create(id: 512, title: "Division", answer: "int a, b, c; a = b/c; System.out.println(a);")
...
puts("# ----------------------- Problems ----------------------- ")
	...
	## Exercise
		...
		Problem.create(title: "Problem 5", description: "This is very easy Problem",
					...
					snippet: "public class CoolSoft {\n\tpublic static void main(String [] args)
					 {\n\t\t\n\t}\n}")
		Problem.create(id: 511, title: "Problem 6 - Multiplication", description: "Multiply a & b and print the result", 
					incomplete: false, seen: true, duplicated: false)
		Problem.create(id: 512, title: "Problem 7 - Division", description: "Divide a & b  and print the result", 
					incomplete: false, seen: true, duplicated: false)
					snippet: "public class CoolSoft {\n\tpublic static void main(String [] args) {\n
					\t\t\n\t}\n}")
...
puts("# ----------------------- Problems ----------------------- ")
	...
	## Model Answers
		...
		Problem.find_by_id(511).model_answers << ModelAnswer.find_by_id(511)
		Problem.find_by_id(512).model_answers << ModelAnswer.find_by_id(512)
	...
	## Hints
		...
		Problem.find_by_id(511).model_answers.find_by_id(511).hints << Hint.find_by_id(511)
		Problem.find_by_id(512).model_answers.find_by_id(512).hints << Hint.find_by_id(512)
