class SolutionsLayer
	...
	def self.execute lang, code, student_id, problem_id, problem_type, cases
		executer = get_executer lang
		unless executer
			return false
		end
		compiler = get_compiler lang
		solution = get_solution code, student_id, problem_id, problem_type
		compile_status = {}
		if compiler
	...
	#	The compile status
	# Author: Mussab ElDash
	def self.compile lang, code, student_id, problem_id, problem_type
		compiler = get_compiler lang
		solution = get_solution code, student_id, problem_id, problem_type
		if compiler
	...
	# Author: Mussab ElDash
	def self.validate lang, code, student_id, problem_id, problem_type, time
		solution = get_solution code, student_id, problem_id, problem_type
		solution.time = time
	...
	# Author: Mussab ElDash
	def self.debug lang, code, student_id, problem_id, problem_type, cases
		solution = get_solution code, student_id, problem_id, problem_type
	...
	#	A new Solution
	# Author: Mussab ElDash
	def self.get_solution code, student_id, problem_id, type = "Problem"
		type = type.capitalize
		solution = Solution.create({code: code, student_id: student_id,
				problem_id: problem_id, problem_type: type})
		return solution
	end
